...
git clone  https://github.com/neslihanatalay/ibb_ecodation_javacore.git
```
---
...
```java
package com.neslihanatalay.project_step2_file;

import com.neslihanatalay.project.step2.EStudentType;
